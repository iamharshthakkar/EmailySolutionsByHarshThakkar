  ...
  renderFeatures() {
    const features = [
      ...
      },
      {
        ...
        feature: "To Add Credits, click the add credit button"
      },
      {
        icon: "touch_app",
    ...
    return (
      <section className="section section-about grey lighten-5 center scrollspy">
        <div className="container">
          <h4>Welcome to Emaily Solutions</h4>
          <p>
            Emaily Solutions allows you to send custom survey emails to your
            clients. Clients can answer your emails via a Yes/No option. Please
    ...
    return (
      <div className="card">
        <div className="card-content">
          <span className="card-title center">Recent Surveys</span>
